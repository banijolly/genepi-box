		...
		<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
			<div class="wrap-login100 p-l-80 p-r-80 p-t-40 p-b-33">
				<div class="login100-form validate-form flex-sb flex-w">
					...
					$target_dir = "../uploads/";
					$target_file_runfolder = $target_dir . "Fastq_1.zip";
					$target_file_config =  "../config.txt";

					$target_file_sampleSheet = $target_dir . "SampleSheet.csv";
					...
					$imageFileType = strtolower(pathinfo($target_file_sampleSheet,PATHINFO_EXTENSION));
					...
					if (move_uploaded_file($_FILES["folderInput"]["tmp_name"], $target_file_runfolder) && move_uploaded_file($_FILES["config"]["tmp_name"], $target_file_config) && move_uploaded_file($_FILES["sampleSheet"]["tmp_name"], $target_file_sampleSheet) && move_uploaded_file($_FILES["metadata"]["tmp_name"], $target_file_metadata) ) {
					...
					shell_exec('./parseAndRun.sh  > /dev/null 2>run.log &');
